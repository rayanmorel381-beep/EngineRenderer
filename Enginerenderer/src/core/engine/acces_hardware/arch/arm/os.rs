...
pub(crate) fn default_ram_config() -> RamConfig {
    #[cfg(any(target_os = "linux", target_os = "android"))]
    {
        ...
        let low_power_from_vendor = matches!(c.vendor, super::linux::ram::vendor::Vendor::Apple);
        return RamConfig {
