//! Win32 registry FFI primitives shared by the Intel GPU probe.
...
unsafe extern "system" {
    pub(super) fn RegOpenKeyExW(key: Hkey, sub_key: *const u16, options: u32, desired: u32, result: *mut Hkey) -> i32;
