...
pub struct NetworkManager {
    ...
    lag_compensator: crate::core::coremanager::netcode::LagCompensator,
}
...
impl NetworkManager {
    ...
    pub fn new(remote_clients: usize) -> Self {
        Self {
            ...
            lag_compensator: crate::core::coremanager::netcode::LagCompensator::new(0.1, 64),
        }
    }
    ...
    pub fn sync_scene(&mut self, graph: &SceneGraph, frame_index: u64) -> NetworkSnapshot {
        ...
        let timestamp = frame_index as f64 / 120.0;
        let origin = graph.focus_point();
        let snapshot_state = crate::core::coremanager::netcode::SnapshotState {
            timestamp,
            position: origin,
            velocity: Vec3::ZERO,
