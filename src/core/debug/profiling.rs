...
//!
//! Debug-oriented formatting and budget checking for frame profiling.

use crate::core::scheduler::profiling::FrameSummary;

/// Format a [`FrameSummary`] as a single debug line.
...
/// Returns `true` when the frame exceeded the target by more than 20 %.
pub fn is_over_budget(summary: &FrameSummary, target_ms: f64) -> bool {
    summary.total_frame_ms as f64 > target_ms * 1.20
}

/// Percentage of total frame time spent in simulation.
